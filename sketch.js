...
function setup() {
  ...
  trex = createSprite(50,windowHeight/2  + 400,20,50);
  ...
  invisibleGround = createSprite(200,windowHeight - 25,windowWidth,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") || touches.length> 0 && trex.y >= windowHeight/2 + 300) {
      trex.velocityY = -12;
    }
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth,windowHeight-57,10,40);
    //obstacle.debug = true;
